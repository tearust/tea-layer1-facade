...
async function main () {
  ...
  const nonce2 = '200';
  const delegator_nonce_hash = stringToU8a(hash(nonce2));
  // todo use real rsa
  const delegator_nonce_rsa = stringToU8a('24d614bd215f1c90345a4b505be6bd0589ac6b105a2a8c059a5890ba953aec11');
  const key_type = stringToU8a('btc');
  // todo use real p1
  const p1 = stringToU8a('24d614bd215f1c90345a4b505be6bd0589ac6b105a2a8c059a5890ba953aec11');
  const p2_n = 3;
  const p2_k = 20;
  ...
  // todo get task_data from api
  // const task_data = await api.rpc.gluon.encodeAccountGenerationWithoutP3(
  //     key_type, p2_n, p2_k, delegator_nonce_hash, delegator_nonce_rsa, p1);
